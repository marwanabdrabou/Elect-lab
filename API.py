...
model_diabetes =joblib.load('D:\\E-lab\\Website\\RF.mdl')
model_Skin=None
model_Xray=None
...
def load_model():
    ...
    global model_Skin
    model_Skin =tf.keras.models.load_model('D:\\E-lab\\Website\\skin_cancer_model.sav')
    
    global model_Xray
    model_Xray=tf.keras.models.load_model('D:\\E-lab\\Website\\x-ray_chest87.sav')
